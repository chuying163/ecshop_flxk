...
<!-- saved from url=(0046)http://www.flxkdns.com/pdtshw/ot5shw/index.asp -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<title>自助建站--月夜星空软件工作室</title>
...
<link href="./index_files/webstyle.css" rel="stylesheet" type="text/css"><script type="text/javascript" src="./index_files/jquery-1.3.2.min.js"></script>
</head>
...
<td width="102" align="center" background="./index_files/menu_02.gif" onmouseover="javascript: this.style.backgroundImage=&#39;url(/ucenter/skins/blue/images/menu_02_over.gif)&#39;;" onmouseout="javascript: this.style.backgroundImage=&#39;url(/ucenter/skins/blue/images/menu_02.gif)&#39;;"><a href="./index_files/site.htm" style="display: block; width: 102; height: 66px; line-height: 52px; font-size: 14px; font-weight: bold; color: white;">自助建站</a></td>
...
<style type="text/css">
#page1{
    background: url("/ucenter/skins/common/images/page_bg.gif") no-repeat scroll 0 0 transparent;
    float: left;
    height: 27px;
    line-height: 32px;
    padding: 5px;
...
#page1 .current {float:left;line-height:27px; background:url(/ucenter/skins/common/images/page_li_hover_bg.gif); margin-left:5px;color:#fff; width:30px; text-align:center; display:block;font-family:Verdana, Geneva, sans-serif;}
#page1 a {float:left; line-height:27px; background:url(/ucenter/skins/common/images/page_li_bg.gif);margin-left:5px;color:#333; width:30px; text-align:center; display:block;font-family:Verdana, Geneva, sans-serif;}
#page1 a:hover{background:url(/ucenter/skins/common/images/page_li_hover_bg.gif); color:#fff;}
...
<!--------香港------------------------------------------------------------>
					...
					<div id="template_show">
						<div class="top">
							...
							<div class="r"><a href="http://www.flxkdns.com/pdtshw/ot5shw/template_show.asp"><img src="./index_files/mb_more.gif"></a></div>
						</div>
                    ...
                    <div class="template_kk">
                        <a href="http://qiche11a36.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/qiche11a36.jpg" alt=" 企业网站-汽车A36" width="170" border="0">
                        </a>
                        <h5>模板编号:3108</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://qipei11a25.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/qipei11a25.jpg" alt=" 企业网站-汽配A25" width="170" border="0">
                        </a>
                        <h5>模板编号:3107</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://qipei11a19.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/qipei11a19.jpg" alt=" 企业网站-汽配A19" width="170" border="0">
                        </a>
                        <h5>模板编号:3106</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://fengjing11a40.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/fengjing11a40.jpg" alt=" 企业网站-风景A40" width="170" border="0">
                        </a>
                        <h5>模板编号:3105</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://guanggao11a24.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/guanggao11a24.jpg" alt=" 企业网站-广告A24" width="170" border="0">
                        </a>
                        <h5>模板编号:3104</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://xiangjiao11a35.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/xiangjiao11a35.jpg" alt=" 企业网站-橡胶A35" width="170" border="0">
                        </a>
                        <h5>模板编号:3103</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://chuanmei11a27.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/chuanmei11a27.jpg" alt=" 企业网站-传媒A27" width="170" border="0">
                        </a>
                        <h5>模板编号:3102</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a63.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a63.jpg" alt=" 企业网站-照明A63" width="170" border="0">
                        </a>
                        <h5>模板编号:3101</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a62.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a62.jpg" alt=" 企业网站-照明A62" width="170" border="0">
                        </a>
                        <h5>模板编号:3100</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a61.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a61.jpg" alt=" 企业网站-照明A61" width="170" border="0">
                        </a>
                        <h5>模板编号:3099</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a57.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a57.jpg" alt=" 企业网站-照明A57" width="170" border="0">
                        </a>
                        <h5>模板编号:3098</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a52.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a52.jpg" alt=" 企业网站-照明A52" width="170" border="0">
                        </a>
                        <h5>模板编号:3097</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a49.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a49.jpg" alt=" 企业网站-照明A49" width="170" border="0">
                        </a>
                        <h5>模板编号:3096</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a41.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a41.jpg" alt=" 企业网站-照明A41" width="170" border="0">
                        </a>
                        <h5>模板编号:3095</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a36.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a36.jpg" alt=" 企业网站-照明A36" width="170" border="0">
                        </a>
                        <h5>模板编号:3094</h5>
                    ...
                    <div class="template_kk">
                        <a href="http://zhaoming11a34.site3.idccenter.net/?key=agent" target="_blank" style="display:block;width:170px;heigth:134px;overflow:hidden;">
                            <img src="./index_files/zhaoming11a34.jpg" alt=" 企业网站-照明A34" width="170" border="0">
                        </a>
                        <h5>模板编号:3093</h5>
                ...
                <td align="center">
                <form name="form1" style="width:300px;" method="post" action="./index_files/site.htm">
